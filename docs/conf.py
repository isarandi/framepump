"""Sphinx configuration for framepump documentation."""
...
# Import the module for source inspection
...
def get_line_numbers(obj):
    """Get the source file and line numbers for an object."""
...
def module_restored(obj):
    """Temporarily restore the original module for source code inspection."""
